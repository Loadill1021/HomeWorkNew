...
private:
    ...
    public:
        ...
        void LastOrder()
        {
            ...
            // 내가 해야할일
            if (MapNodeType::Root != this->Type)
            {
                MapNode* DeleteNode = this;
                DeleteNode->Pair_.first = {};
                DeleteNode->Pair_.second = {};
                delete DeleteNode;
                DeleteNode = nullptr;
...
public:
    ...
    void DeleteAllNode()
    {
        RootNode_->LastOrder();//DeleteAllNode();
    }
public:
    GameMap()
        : RootNode_(nullptr)
